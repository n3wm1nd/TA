...
local weapons = {
	...
	thermite_mine = { radius = 64, damage = 750, duration = 200, rangeFall = 0.5, timeFall = 0.5},
	tllaether_thermite_bomb = { radius = 64, damage = 750, duration = 200, rangeFall = 0.5, timeFall = 0.5},
